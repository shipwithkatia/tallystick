...
- [ ] v0.7 — real agent trajectories: read the [AgentHallu](https://arxiv.org/abs/2601.06818) trajectories (693 runs of seven agent frameworks, 443 of them with the responsible step labelled by hand) and compare `break_step_id` with the labelled step on its Retrieval cases, in particular Summarize Misalign — the first measurement of this audit against human step attribution, on traces nobody built for it
